...
public class NovoPedidoCompraMain {
    public static void main( String[] args ) throws ExecutionException, InterruptedException {
        ...
        try(KafkaDispatcher<Compra> compraDispatcher = new KafkaDispatcher<>()) { // qualquer exception que aconteça aqui dentro, existira uma tentativa de fechar esse producer
